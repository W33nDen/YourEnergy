var A=t=>{throw TypeError(t)};var R=(t,a,e)=>a.has(t)||A("Cannot "+e);var _=(t,a,e)=>(R(t,a,"read from private field"),e?e.call(t):a.get(t)),B=(t,a,e)=>a.has(t)?A("Cannot add the same private member more than once"):a instanceof WeakSet?a.add(t):a.set(t,e);var f=(t,a,e)=>(R(t,a,"access private method"),e);(function(){const a=document.createElement("link").relList;if(a&&a.supports&&a.supports("modulepreload"))return;for(const s of document.querySelectorAll('link[rel="modulepreload"]'))n(s);new MutationObserver(s=>{for(const r of s)if(r.type==="childList")for(const c of r.addedNodes)c.tagName==="LINK"&&c.rel==="modulepreload"&&n(c)}).observe(document,{childList:!0,subtree:!0});function e(s){const r={};return s.integrity&&(r.integrity=s.integrity),s.referrerPolicy&&(r.referrerPolicy=s.referrerPolicy),s.crossOrigin==="use-credentials"?r.credentials="include":s.crossOrigin==="anonymous"?r.credentials="omit":r.credentials="same-origin",r}function n(s){if(s.ep)return;s.ep=!0;const r=e(s);fetch(s.href,r)}})();const Z=()=>{var n,s,r,c;const t=window.location.pathname,a=document.querySelectorAll(".nav-link"),e=document.querySelectorAll(".mobile-nav-link");[...a,...e].forEach(p=>{p.classList.remove("active")}),t.includes("favorites")?((n=a[1])==null||n.classList.add("active"),(s=e[1])==null||s.classList.add("active")):((r=a[0])==null||r.classList.add("active"),(c=e[0])==null||c.classList.add("active"))},N=document.querySelector("[data-menu-open]"),O=document.querySelector("[data-menu-close]"),q=document.querySelector("[data-menu]");N&&O&&q&&(N.addEventListener("click",()=>{q.classList.add("is-open")}),O.addEventListener("click",()=>{q.classList.remove("is-open")}));Z();var S,u,v;class w{constructor(){B(this,u);B(this,S,"https://your-energy.b.goit.study/api")}async getQuote(){return f(this,u,v).call(this,"/quote")}async getFilters(a="Muscles",e=1,n=12){const s=new URLSearchParams({filter:a,page:e,limit:n});return f(this,u,v).call(this,`/filters?${s}`)}async getExercises({bodypart:a="",muscles:e="",equipment:n="",keyword:s="",page:r=1,limit:c=10}={}){const p=new URLSearchParams({page:r,limit:c});return a&&p.append("bodypart",a),e&&p.append("muscles",e),n&&p.append("equipment",n),s&&p.append("keyword",s),f(this,u,v).call(this,`/exercises?${p}`)}async getExerciseById(a){return f(this,u,v).call(this,`/exercises/${a}`)}async patchRating(a,e){return f(this,u,v).call(this,`/exercises/${a}/rating`,{method:"PATCH",headers:{"Content-Type":"application/json"},body:JSON.stringify(e)})}async createSubscription(a){return f(this,u,v).call(this,"/subscription",{method:"POST",headers:{"Content-Type":"application/json"},body:JSON.stringify({email:a})})}}S=new WeakMap,u=new WeakSet,v=async function(a,e={}){const n=`${_(this,S)}${a}`;try{const s=await fetch(n,e);if(!s.ok){const r=new Error(`API Error: ${s.status} ${s.statusText}`);throw r.status=s.status,r}return await s.json()}catch(s){throw s}};const X=new w,U="yourEnergy_quote";function W(){return new Date().toISOString().split("T")[0]}function ee(){try{const t=localStorage.getItem(U);if(!t)return null;const{date:a,quote:e,author:n}=JSON.parse(t);return a===W()?{quote:e,author:n}:null}catch{return null}}function te(t,a){try{const e={date:W(),quote:t,author:a};localStorage.setItem(U,JSON.stringify(e))}catch{}}async function ae(){const t=document.getElementById("quote-wrapper");if(t)try{const a=ee();let e;a?e=a:(e=await X.getQuote(),te(e.quote,e.author));const n=document.getElementById("quote-text"),s=document.getElementById("quote-author");n&&s&&(n.textContent=e.quote,s.textContent=e.author,t.classList.remove("hidden"))}catch{const e=document.getElementById("quote-text"),n=document.getElementById("quote-author");e&&n&&(e.textContent="The only bad workout is the one that didn't happen.",n.textContent="Unknown",t.classList.remove("hidden"))}}function j(t,a,e=1){if(a<=1){t.innerHTML="";return}let n="";for(let s=1;s<=a;s++)s===1||s===a||s>=e-2&&s<=e+2?n+=`
  ...
  `;i.exerciseModalContent.innerHTML=n;const s=i.exerciseModalContent.querySelector(".give-rating-btn");s&&s.addEventListener("click",Se);const r=i.exerciseModalContent.querySelector(".add-to-favorites-btn");r&&r.addEventListener("click",()=>xe(t,r))}function xe(t,a){const e=z(t._id),n='<svg class="heart-icon" width="18" height="18"><use href="/YourEnergy/sprite.svg#icon-heart"></use></svg>';e?(ye(t._id),d("Removed from favorites","success"),a.innerHTML=`Add to favorites ${n}`):(he(t),d("Added to favorites!","success"),a.innerHTML=`Remove from favorites ${n}`)}function Se(){if(!m)return;const t=m;i.exerciseModalBackdrop.classList.add("is-hidden"),i.exerciseModalContent.innerHTML="",m=t,i.ratingModalBackdrop.classList.remove("is-hidden"),document.body.style.overflow="hidden",L=0,V(),i.ratingForm.reset(),document.addEventListener("keydown",C)}function $(){i.ratingModalBackdrop.classList.add("is-hidden"),m=null,document.body.style.overflow="",document.removeEventListener("keydown",C)}function ke(t){const a=t.target.closest(".star-icon");a&&(L=parseInt(a.dataset.rating),V())}function V(){const t=i.ratingStars.querySelectorAll(".star-icon");i.ratingValueSpan.textContent=L.toFixed(1),t.forEach((a,e)=>{e<L?a.classList.add("filled"):a.classList.remove("filled")})}async function Me(t){t.preventDefault();const a=new FormData(i.ratingForm),e=a.get("email"),n=a.get("review");if(!m||L===0||!e){d("Please provide a rating and your email.","error");return}try{const s=await J.addRating(m,{rate:L,email:e,review:n});d("Thank you for your rating!","success"),$()}catch(s){d("Failed to submit rating. "+(s.message||"Please try again."),"error")}}const Ce=new w,g={favoritesContainer:document.getElementById("favorites-container"),favoritesEmpty:document.getElementById("favorites-empty"),quoteWrapper:document.getElementById("quote-wrapper")};async function $e(){G(),g.favoritesContainer.addEventListener("click",Te),K(),await Be()}async function Be(){if(!g.quoteWrapper)return;const t=g.quoteWrapper.querySelector("#quote-text"),a=g.quoteWrapper.querySelector("#quote-author"),e=new Date().toDateString(),n=M("quote");if(n&&n.date===e)s({quote:n.quote,author:n.author});else try{const r=await Ce.getQuote();if(!r||!r.quote)throw new Error("No quote data");const c={...r,date:e};k("quote",c),s({quote:c.quote,author:c.author})}catch{s({quote:"The only bad workout is the one that didn't happen.",author:"Unknown"})}function s({quote:r,author:c}){t&&(t.textContent=r),a&&(a.textContent=c),g.quoteWrapper.classList.remove("hidden")}}function G(){const t=M("favorites")||[];if(t.length===0){g.favoritesEmpty.classList.remove("hidden"),g.favoritesContainer.innerHTML="";return}g.favoritesEmpty.classList.add("hidden");const a=t.map(e=>`
    <li class="exercise-card" data-id="${e._id}">
